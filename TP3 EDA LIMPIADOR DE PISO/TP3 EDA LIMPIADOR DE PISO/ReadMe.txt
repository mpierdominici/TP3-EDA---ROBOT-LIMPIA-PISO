========================================================================
    APLICACIÓN DE CONSOLA: TP3 EDA LIMPIADOR DE PISO Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación TP3 EDA LIMPIADOR DE PISO.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación TP3 EDA LIMPIADOR DE PISO.


TP3 EDA LIMPIADOR DE PISO.vcxproj
...
TP3 EDA LIMPIADOR DE PISO.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado TP3 EDA LIMPIADOR DE PISO.pch y un archivo de tipos precompilados llamado StdAfx.obj.
